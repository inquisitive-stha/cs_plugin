...
include_once('public/MathEngine.php');
...
include_once('testcase/test.php');
...
//echo '======================='.$price;
//
////$price = MathEngine::findPaperCost(1700,14,2,'double',14);
//$price = MathEngine::findPaperCost(1700,14,2,2,14);
////echo '======================='.$price;
//
//$price = MathEngine::findPrintingCost(1700, 'cl', 14, 14);
////echo '======================='.$price;
//
//$price = MathEngine::findTaskPrice(1,50,5,1,0);
//echo '======================='.$price;
