...
<table class="wp-list-table widefat fixed striped pages table-responsive">
    ...
    <tbody id="nrow">
        ...
        <tr id="tr-<?php echo $l->id; ?>">
            <th> 
                 <select disabled class="db_task_id form-control percent_50">
                        <?php
                        foreach ($model as $m) {
                            ?>
                            <option value="<?php echo $m->id; ?>" <?php echo ($l->task_id == $m->id) ? 'selected' : ''; ?>>
        ...
        <tr id="add_tmpl" style="display: none;">
            <th>  
                <select class="db_task_id form-control percent_50">
                            <?php
                            foreach ($model as $m) {
                                ?>
                                <option value="<?php echo $m->id; ?>" <?php echo ($l->task_id == $m->id)?'selected':''; ?>>
