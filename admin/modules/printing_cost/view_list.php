...
<script type="text/javascript">
    ...
    function doEdit(b)
    {
        ...
        jQuery.ajax({
                ...
                data: { action: "saveprcost",format_id:format_id, p_from: p_from,p_to: p_to,bw: bw,color: color, id: id}
              })
                .done(function( msg ) {
                    if(msg.success == '1')
                    {
    ...
    function doAdd(b)
    {
        ...
        jQuery.ajax({
                ...
                dataType: "json",
                url: "<?php echo admin_url('admin-ajax.php'); ?>",
                data: { action: "saveprcost",format_id:format_id, p_from: p_from,p_to: p_to,bw: bw,color: color}
              })
                .done(function( msg ) {
                    if(msg.success == '1')
                    {
